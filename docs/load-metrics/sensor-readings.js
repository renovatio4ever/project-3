var client = new ARMSio({
  ...
  ARMSio.ready(function(){
    ...
    var chart_visitors = new ARMSio.SensorData()
      .el('#visitors')
      .height(300)
      .title('Total Load (Business)')
      .type('area');
  
    var chart_browsers = new ARMSio.SensorData()
      .el('#browser')
      .height(300)
      .title('Total Load (Residential)')
      .type('area');
  
    var chart_geographies = new ARMSio.SensorData()
      .el('#geography')
      .type('horizontal-bar')
      .title('Distribution')
      .height(300);
      ...
      return geoProject
        ...
        .then(function(res) {
          chart
            .data(res)
            .labelMapping({
              'Return of the Uno' : 'Single',
              'Solo Uno' : 'Double',
              'Uno Strikes Back': 'Condo Towers',
              'null': 'Resorts'
            })
            .render();
        })
      ...
      return client
        ...
        .then(function(res) {
          chart
            .data(res)
            .labelMapping({
              'New Jersey' : 'The Secret Collider - xDR1',
              'Virginia' : 'Nuclear',
              'California': 'Hydro',
              'Washington': 'Solar',
              'Utah': 'Wind',
    ...
    var sample_funnel = new ARMSio.SensorData()
      .el('#chart-05')
      .colors(['#00cfbb'])
      .data({ result: [ 4555, 3250, 3000, 2432, 1504, 321 ] })
      .height(340)
      .type('bar')
      .labels(['Oil', 'Bushing', 'Breakers', 'Relays', 'Sensor', 'Line'])
      .title(null)
      .render();
    ...
    initialize = function() {
      ...
      map = L.mapbox.map('map', 'ARMSio-io.kae20cg0', {
